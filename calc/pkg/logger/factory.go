...
import (
	...
	"github.com/klimenkokayot/calc-net-go/pkg/logger/adapters/logrus"
	"github.com/klimenkokayot/calc-net-go/pkg/logger/adapters/zap"
	"github.com/klimenkokayot/calc-net-go/pkg/logger/domain"
)
