...
import (
	...
	"github.com/klimenkokayot/calc-user-go/api-gateway/pkg/logger/adapters/logrus"
	"github.com/klimenkokayot/calc-user-go/api-gateway/pkg/logger/adapters/zap"
	"github.com/klimenkokayot/calc-user-go/api-gateway/pkg/logger/domain"
)
